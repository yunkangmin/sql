...
WITH SeqNumTbl(SeqNum) AS ( 
  ...
  -- WHERE SeqNum < ADD_MONTHS(TRUNC(SYSDATE, 'YEAR'), 24) - ADD_MONTHS(TRUNC(SYSDATE, 'YEAR'), 12) 
   WHERE SeqNum < ADD_MONTHS(TRUNC(TO_DATE('2016-01-01', 'YYYY-MM-DD'), 'YEAR'), 24) - ADD_MONTHS(TRUNC(TO_DATE('2016-01-01', 'YYYY-MM-DD'), 'YEAR'), 12) 
)
SELECT --ADD_MONTHS(TRUNC(SYSDATE, 'YEAR'), 12) + SeqNum - TO_DATE('15-10-1582', 'DD-MM-YYYY'), ADD_MONTHS(TRUNC(SYSDATE, 'YEAR'), 12) + SeqNum  
       ADD_MONTHS(TRUNC(TO_DATE('2016-01-01', 'YYYY-MM-DD'), 'YEAR'), 12) + SeqNum - TO_DATE('15-10-1582', 'DD-MM-YYYY'), ADD_MONTHS(TRUNC(TO_DATE('2016-01-01', 'YYYY-MM-DD'), 'YEAR'), 12) + SeqNum  
FROM SeqNumTbl;
